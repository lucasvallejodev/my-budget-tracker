...
export function DialogContent({
  ...
  return (
    <RadixDialog.Portal>
      ...
      >
        {children}
        <RadixDialog.Close className="dialog__close" aria-label="Close dialog">
          <X size={20} />
        </RadixDialog.Close>
      </RadixDialog.Content>
    </RadixDialog.Portal>
...
export function DialogTitle({ className, ...props }: ComponentProps<typeof RadixDialog.Title>) {
  return <RadixDialog.Title className={cn('dialog__title', className)} {...props} />;
}
...
export function DialogDescription({
  ...
  return <RadixDialog.Description className={cn('dialog__description', className)} {...props} />;
}
