...
CREATE UNIQUE INDEX "transactions_account_import_key" ON "transactions" USING btree ("account_id","import_id") WHERE "transactions"."import_id" IS NOT NULL AND "transactions"."deleted_at" IS NULL;--> statement-breakpoint
