  ...
  return (
    <Dialog open={open} onOpenChange={setOpen}>
      ...
      <DialogContent>
        <DialogTitle>
          Create
          <span className={cn('m-1', type === 'income' ? 'text-emerald-500' : 'text-orange-500')}>
            {type === 'income' ? 'income' : 'expense'}
          </span>{' '}
          category
        </DialogTitle>
        <DialogDescription>
          Categories are used to group your transactions. You can create a new category for your
          transactions.
        </DialogDescription>
        <Form {...form}>
