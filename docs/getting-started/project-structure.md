...
| `docker-compose.yml`, `Dockerfile`, `.dockerignore`                                                                                                                            | Local PostgreSQL and the optional `api` and `web` containers. The `Dockerfile` has two final targets: `api` (migrates, then serves Fastify) and `web` (Next.js standalone).                                                                                                                                                                                                                                                                                                                                               |
...
| `.github/workflows/`                                                                                                                                                           | CI on Node 24: `quality.yml` (lint, types, tests, duplication, build), `sonar.yml` (SonarQube Cloud), `playwright.yml` (end-to-end tests against a PostgreSQL service container).                                                                                                                                                                                                                                                                                                       |
