...
| `npm run test:e2e`                        | Playwright end-to-end tests in `e2e/` (requires a running app; a test can sign up its own local user; the sample spec only visits playwright.dev).                                                                                                                                                        |
