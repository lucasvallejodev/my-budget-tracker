  ...
  return (
    <div className="flex items-start gap-6 w-full">
      <div className="flex flex-col items-start gap-3 flex-1">
        <div className="text-base font-bold text-neutral-1000 leading-7">{name}</div>
      ...
      <div className="flex flex-col items-end gap-0.5">
        <div className="text-base font-bold text-neutral-1000 leading-7">${amount}</div>
        <div className="text-xs text-neutral-800 leading-4">Left ${leftAmount}</div>
      </div>
    </div>
  );
}
