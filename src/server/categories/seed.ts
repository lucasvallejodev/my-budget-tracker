...
import { Db } from '../db';
import { DEFAULT_TAXONOMY, DEFAULT_TAXONOMY_VERSION } from './default-taxonomy';
 ...
 */
export async function ensureUserBootstrap(db: Db, userId: string, primaryCurrency = 'EUR') {
  ...
  return db.transaction(async tx => {
    ...
    for (const [groupIndex, group] of DEFAULT_TAXONOMY.entries()) {
