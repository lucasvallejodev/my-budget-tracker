...
| `src/styles/theme.ts`, `src/styles/tokens.scss`, `src/lib/*` helpers, `src/constants/*` | `architecture/code-style.md`, `architecture/frontend.md` › Styling                       | `agents/conventions.md` › Reuse first / Styling / Documentation comments      | —                           |
...
| `eslint.config.mjs`, `.stylelintrc.json`, `scripts/eslint-rules/*`, `.prettierrc.js`    | `architecture/code-style.md`, `getting-started/commands.md`                              | `agents/conventions.md` › Tooling gates / Formatting / Documentation comments | **yes** (Commands)          |
