...
| `src/components/**`, styling, hooks                                                                               | `architecture/frontend.md`, `architecture/components.md`, the feature page of the screen | `agents/components.md`, `agents/conventions.md` › Client/Components/Styling   | —                           |
| `src/styles/theme.ts`, `src/styles/tokens.scss`, `src/styles/abstracts/*`, `src/lib/*` helpers, `src/constants/*` | `architecture/code-style.md`, `architecture/frontend.md` › Styling                       | `agents/conventions.md` › Reuse first / Styling / Documentation comments      | —                           |
